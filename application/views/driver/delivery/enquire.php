  ...
  <script type="text/javascript">
    ...
    function onPositionUpdate(position) {
     ...
     var id =  $("#delivery_id").val();
       $.ajax({
        method:'post',
        url: base_url+"driver_dashboard/get_driver_location",
        dataType:'json',
        data:{id:id},
        ...
        { 
          ...
          $("#start_lat").val(data.lat);
          $("#start_lng").val(data.lng);
...
<body>
 ...
 <input type="hidden" id="drop_lat" value="<?php echo $lat ?>">
 <input type="hidden" id="drop_lng" value="<?php echo $lng; ?>">
 <input type="hidden" id="delivery_id" value="<?php echo $id; ?>">
